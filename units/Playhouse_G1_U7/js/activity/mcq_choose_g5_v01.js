...
MCQ.prototype = {
    ...
    showIcons:function(aBoo, aVal, aResult){
        ...
        for (var i = 0; i < elsQue.length; i++) {
            // FIX: لازم نستخدم data-qno الحقيقي تبع العنصر، مش رقم اللفة i،
            // لأنو ممكن يكون في أسئلة "no_que" (بدون خيارات) بينهم بتعمل
            // فجوة برقم الأسئلة، وبتخلي aVal[i] يقرأ نتيجة سؤال غلط
            var realIndx = parseInt(elsQue[i].dataset.qno) - 1;
            if(aBoo){
                if(elsQue.length != 1){

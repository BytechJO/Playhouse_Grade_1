...
function buildDrawQABody(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    htmlStmt +=
      '<div class="clearDrawBtn"><img src="../images/icons/reset_btn.png"></div>';
    htmlStmt += "</div>";
    ...
    for (var x = 0; x < aObj.qaPairs.length; x++) {
      ...
      htmlStmt +=
        '<div class="char_img q_icon"><img src="' + pairObj.boyImg + '"></div>';
      htmlStmt +=
        '<div class="line_input_wrap"><input class="text_input_area qa_input q_input" type="text" maxlength="' +
        aObj.maxlength +
        '"></div>';
      ...
      htmlStmt +=
        '<div class="line_input_wrap"><input class="text_input_area qa_input a_input" type="text" maxlength="' +
        aObj.maxlength +
        '"></div>';
      htmlStmt +=
        '<div class="char_img a_icon"><img src="' +
        pairObj.girlImg +
        '"></div>';
      htmlStmt += "</div>";

var stereo_data = {
    ...
    "playListData" : [
        {
          'audiourl': '../audios/page_71/PLAYHOUSE_1_WB_UNIT_14_TRACK_05_01.mp3',
        },
        {
          'url': '',
        },
...
var fillin_data = {    
    ...
    "subTitleTextLeft"      : "<span class='blue_text'>1</span> Look and write. Use It is.",
    "subTitleTextRight"     : "",
    "subTitleIcons"         : [],
    ...
    "questions": [{
        ...
        },
        {
            ...
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "../images/pages/activities/3-img-5.png",
            "answer": ["cold"],
            "strictcase": "no", // yes (or) no 
            "type": "text", // text (or) number
        },
        {
            ...
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "../images/pages/activities/3-img-6.png",
            "answer": ["windy"],
            "strictcase": "no", // yes (or) no
            "type": "text", // text (or) number
        },
